...
describe('CandleKeeper', () => {
    ...
    it('should work with backfill empty candles', () => {
        ...
        const candleKeeper = new candleKeeper_1.CandleKeeper({ period: 300, onNewCandle });
        candleKeeper.add(1000, 1250);
        expect(candleKeeper.get()).toEqual({
            ts: 0,
            max: 1250,
    ...
    it('should work with shiftMs', () => {
        const candleKeeper = new candleKeeper_1.CandleKeeper({ period: 300, shiftMs: -5000 });
    ...
    it('should work with volume and cost', () => {
        const candleKeeper = new candleKeeper_1.CandleKeeper({ period: 300, includesVolume: true });
